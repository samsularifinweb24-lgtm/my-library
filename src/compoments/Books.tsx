...
//   return (
//     <div className={`${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"} min-h-screen relative overflow-hidden p-6`}>
...
//       {/* Animated Heading */}
//       <motion.h1
//         className="text-4xl font-extrabold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-pink-500 to-red-500"
//         animate={{ x: [0, 20, -20, 0] }}
...
//         {showCart && (
//           <div className="w-72 bg-white dark:bg-gray-900 rounded-xl shadow-lg overflow-hidden">
//             {cart.length === 0 ? (
